...
class VideoPlayer extends Component {
  ...
  srcAllPlatformList = [
    ...
    },
    {
      ...
      uri: 'https://edge.sariska.io/play/hls/uhkxffpjjjezhsip/3rhrv9h7w70bjeau.m3u8',
    },
    {
  ...
  srcAndroidList = [
    {
      description: 'Another live sample',
      uri: 'https://low-latency-edge.sariska.io/original/k1sk0rlqr2rsihi5/v1yooqk4342xc2na/playlist.m3u8',
    },
    {
      description: '(dash) sintel subtitles',
      uri: 'https://low-latency-edge.sariska.io/original/k1sk0rlqr2rsihi5/v1yooqk4342xc2na/playlist.m3u88',
    },
    {
    ...
    return (
      <TouchableOpacity style={viewStyle}>
        <Video
          ...
          source={"https://low-latency-edge.sariska.io/original/k1sk0rlqr2rsihi5/v1yooqk4342xc2na/playlist.m3u8"}
